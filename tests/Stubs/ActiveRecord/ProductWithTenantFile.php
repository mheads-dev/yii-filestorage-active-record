...
final class ProductWithTenantFile extends ActiveRecord implements PendingUploadedFileOwnerInterface
{
	...
	public ?int $id;
	public string $name = '';
	#[FileUpload(groupName: 'products', storeName: 'upload', fileClass: Tenant42ArFile::class)]
	...
	public function getPicture(): ?Tenant42ArFile
	{
		/** @var Tenant42ArFile|null */
		return $this->relation('picture');
	}

	public function getPictureQuery(): ActiveQuery
	{
		return $this->hasOne(Tenant42ArFile::class, ['id' => 'picture_id']);
	}
